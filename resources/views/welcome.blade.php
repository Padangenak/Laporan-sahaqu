    ...
    <div id="navbarBasicExample" class="navbar-menu" :class="{ 'is-active': showNav }">
      <div class="navbar-end">
        <div class="navbar-item">
          <div class="buttons">
            @auth
            <a href="{{ route('admin.participant') }}" class="button is-primary">Go to dashboard</a>
            @endauth
            @guest
  ...
  <div class="container duplicate-container">
    ...
    <div id="tahajjud">
      <div class="card">
        ...
        @if($report->participant_id == $participant->id && $report->day_id == $maxdays &&
        date("l",($report->create/1000)) == date("l",($time/1000)) && $report->type == "tahajjud")
        @php
        ...
        @foreach($reports as $report)
        @if($report->participant_id == $participant->id && $report->day_id == $maxdays &&
        date("l",($report->create/1000)) == date("l",($time/1000)) && $report->type == "dhuha")
        @php
            ...
            <table class="table is-fullwidth">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Monday" && $report->day_id == $maxdays && $participant->id
                    == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  </td>
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Tuesday" && $report->day_id == $maxdays && $participant->id
                    == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Wednesday" && $report->day_id == $maxdays &&
                    $participant->id == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  </td>
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Thursday" && $report->day_id == $maxdays &&
                    $participant->id == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Friday" && $report->day_id == $maxdays && $participant->id
                    == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Saturday" && $report->day_id == $maxdays &&
                    $participant->id == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Sunday" && $report->day_id == $maxdays && $participant->id
                    == $report->participant_id && $report->type == "tahajjud")
                    {{ $report->status }}
                    @endif
                    @endforeach
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Monday" && $report->day_id == $maxdays && $participant->id
                    == $report->participant_id && $report->type == "dhuha")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  </td>
                  ...
                  <td>
                    @foreach($reports as $report)
                    @if(date("l",($report->create/1000)) == "Wednesday" && $report->day_id == $maxdays &&
                    $participant->id == $report->participant_id && $report->type == "dhuha")
                    {{ $report->status }}
                    @endif
                    @endforeach
                  </td>
